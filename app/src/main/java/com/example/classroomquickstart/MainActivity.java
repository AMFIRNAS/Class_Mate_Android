...
public class MainActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProgress.setMessage("Loading Google Services");
    ...
    private void getResultsFromApi() {
        if (! isGooglePlayServicesAvailable()) {
            ...
            tvOutput.setText("Tap Here to Try Again");
    ...
    private class MakeRequestTask extends AsyncTask<Void, Void, List<String>> {
        ...
        private List<String> getDataFromApi() throws IOException {
            ...
            if (courses != null) {
                for (Course course : courses) {
                    names.add(course.getName()+"//"+course.getId());
                    mService.courses().courseWork().list(course.getId());
                }
            }
            return names;
        }
        ...
        protected void onPostExecute(List<String> output) {
            ...
            if (output == null || output.size() == 0) {
                tvOutput.setText("Tap Here to Try Again");
                alert("You haven't enrolled to any Subjects");
            } else {
                tvOutput.setText("Redirecting to Home Page");
                String[] courseArray = output.toArray(new String[0]);
                Intent int1 = new Intent(getApplicationContext() ,HomeActivity.class);

                Bundle b=new Bundle();
                b.putStringArray("courses", courseArray);
                int1.putExtras(b);
                tvOutput.setText("Tap Here to Sign in with Google");
        ...
        protected void onCancelled() {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    tvOutput.setText("Tap Here to Try Again");
                    String[] parts = mLastError.getMessage().split(" ");
                    if(parts[0].equals("403")){
                        alert("You can't use Google Classroom with this account. \n\n"+
                                "If your school uses Google Apps for Education, sign in with your school account.");
                    }
                    else{
